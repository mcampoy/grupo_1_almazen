...
INSERT INTO `products` VALUES (1,1,'ESP006','Cúrcuma','La cúrcuma, también denominada azufre de Indias, es una planta muy apreciada por su versatilidad gastronómica. Se le atribuyen propiedades medicinales contra el cáncer, el colesterol alto o la artrosis, entre otras enfermedades. Es nativa del suroeste de la India y es una raíz de la familia del jengibre. Se utiliza como colorante por su inconfundible color amarillo. Además, aporta un cautivante sabor dulzón con un toque picante y amargo, por lo que conviene incorporarlo en pequeñas cantidades','Cúrcuma en polvo para darle sabor y color a tus comidas',100,'gr',60,12,20,7,'curcuma en polvo.jpg',1),(2,1,'ALM0421','Cacao','El cacao es un árbol procedente de América que produce un fruto del mismo nombre que se puede utilizar como ingrediente para alimentos entre los que destaca el chocolate. Su uso se remonta a la época de los mayas, aztecas e incas, y desde entonces se ha usado tanto para fines nutricionales como médicos. Su principal uso es para hacer chocolate. De este fruto se consigue tanto el polvo de cacao como la manteca. Ambas se suelen mezclar junto a azúcares refinados y leche.','Cacao en polvo para darle sabor y color a tus preparaciones',250,'gr',300,10,12,80,'Cacao - 22-6-2020 11_0_56.jpg',1),(3,1,'ALM0145','Stevia','La Stevia, originaria de Paraguay (ka’a he’e o “la hierba dulce” en guaraní), es una planta de la familia del girasol y se ha convertido en uno de los cultivos con mayor potencial en el mundo. La Stevia tiene una capacidad edulcorante equivalente a 300 veces la del azúcar, sus propiedades son únicas en el mundo.','Una manera natural de endulzar tus preparaciones',110,'gr',170,20,30,60,'stevia.jpg',1),(4,1,'ESP001','Anís en grano','Esta planta comenzó a emplearse como remedio natural en la época romana, pero se ha convertido en uno de los ingredientes que no pueden faltar en la cocina. Conocido principalmente por sus propiedades digestivas, el anís en grano es ideal tanto para acompañar tus sobremesas, servirte como calmante antes de acostarte o de ingrediente en diferentes recetas.  Se puede consumir a modo de infusión en cualquier momento del día, pero también como condimento o complemento en numerosas recetas, principalmente postres y cócteles.','Su inconfundible perfume en tu cocina.',100,'gr',80,0,0,15,'anis en grano.jpg',1),(5,1,'ESP002','Canela en rama','La canela procede de la corteza del canelo, un árbol tropical de hoja perenne. Lo más interesante de la canela son los compuestos aromáticos. Molida se utiliza ampliamente en postres, pasteles, dulces, etc., y entera se emplea para adornar y sazonar algunos platos. Muchas cocinas tradicionales, como la india, la mexicana, la del Medio Oriente y la del norte de África, utilizan la canela como principal especia en los platos salados.','Un toque de canela para decorar y sazonar tus comidas ',100,'gr',300,0,15,23,'canela en rama.jpg',1),(6,1,'ESP003','Cardamomo','El cardamomo se cultivó por el hombre por primera vez en el año 700 y fue en Europa donde se probó esta planta descubriendo todos los beneficios que trae consigo. Es una de las plantas más costosas junto al azafrán y la vainilla. Debido a su sabor agridulce, el cardamomo es un perfecto saborizador para guisos, salsas, sopas entre otros. Utilizar una semilla entera de cardamomo para la preparación.','Un toque de sabor agridulce a tus platos.',25,'gr',200,0,0,49,'cardamomo.jpg',1),(7,1,'ESP004','Clavo de olor','Los granos del clavo de olor se utilizan enteros o molidos pero, como son extremadamente fuertes, se usan en poca cantidad. Es una especia muy empleada en la gastronomía de toda Europa y Asia.  Se suele utilizar tanto entero como molido y en preparaciones dulces o saladas. Se recomienda utilizarlo en pequeñas cantidades ya que es de sabor muy fuerte, picante y ardiente, y de sabor amargo. El clavo de olor combina muy bien con distintas especies como la nuez moscada y la canela.','Un toque de clavo de olor para dar un sabor más picante a tus comidas.',100,'gr',260,0,25,15,'clavo de olor.jpg',1),(8,1,'ESP005','Comino','El comino es de la misma familia del perejil, usada desde la antigüedad como planta medicinal para mejorar la digestión, los forúnculos o el insomnio. Una especie muy común en la cocinas india y persa. El comino surgió en la zona de Irán. Es una especia muy apreciada por los egipcios, así como romanos y griegos. Las semillas de comino son una buena fuente de hierro. Es una especia ideal para la digestión. Combina con la mayoría de los alimentos y sumamente útil para condimentar sopas, diversas legumbres y vegetales.','Un sabor inconfundible en tus alimentos.',100,'gr',80,0,NULL,22,'comino.jpg',1),(9,1,'ESP007','Curry','La palabra curry viene en su origen de la palabra kari, que significa salsa en Tamil, el idioma hablado por una etnia del sur de la India que elaborada una serie de platos muy especiados con un sabor muy característico.Una deliciosa combinación de varias especias entre las que se suele encontrar azafrán, canela, cilantro, comino, cúrcuma, jengibre o pimienta. Esta combinación resulta en un condimento muy utilizado en una gran cantidad de platos de, especialmente, las gastronomías asiáticas para conformar estofados y guisos con salsas. Es uno de los condimentos más utilizados hoy en día.','Un aliado infaltable en tu cocina',100,'gr',40,0,NULL,23,'curry.jpg',1),(10,1,'ESP008','Eneldo','Originaria de la cuenca del Mediterráneo y Asia Menor, y utilizada por las primeras civilizaciones de la humanidad, actualmente se cultiva en casi todo el mundo. Es un ingrediente básico en muchos países, indispensable en las cocinas de los países nórdicos y bálticos. Con el eneldo fresco se pueden aromatizar todo tipo de platos, se puede añadir, además de a los pescados, a mariscos, carnes, arroces, ensaladas, vinagres y aceites aromatizados, salsas… proporciona su sabor dulzón, fresco y anisado, un sabor único que ninguna otra planta aromática puede proporcionar.','Un toque distintivo a tus preparaciones con este condimento.',100,'gr',100,0,15,80,'eneldo.jpg',1),(11,1,'ESP009','Jengibre','El jengibre o quion es una planta perteneciente a la familia de las zingiberáceas que crece en todas las regiones tropicales del mundo.  Es muy preciado por su aroma y sabor picante. Se utiliza principalmente en la cocina asiática. En este tipo de comida, los rizomas se pueden agregar como ingrediente en muchos de sus platos o conservarse en vinagre y consumirse como aperitivo. Además, el sabor picante hace que el jugo del rizoma se use como condimento en el marisco y el cordero en la cocina china.','Un toque de picante y un aroma inconfundible.',100,'gr',30,0,25,80,'jengibre.jpg',1),(12,1,'ESP015','Mostaza en grano','La mostaza es una de las especias más antiguas utilizadas. Es una planta de la familia crucíferas (Brassica nigra). Cuando la mostaza se hierve el picante se reduce notablemente. La mostaza actúa como conservante, por lo que es ideal para los adobos y demás platos conservados en vinagre. También podés utilizar los polvos de mostaza para condimentar harina, en multitud de platos sabrosos o masas, y también para sopas y salsas.','Atrevete a experimentar con una de las especias más antiguas.',100,'gr',70,0,35,80,'mostaza.jpg',1),(13,1,'ESP010','Nuez moscada','La nuez moscada es el fruto del árbol tropical Myristica fragrans, aunque hay más especies de la familia de las Myristicaceae, es originaria de las Molucas (Indonesia), archipiélago conocido como Islas de las Especias. Fue en su tiempo una de las especias más valoradas. Son muchos los platos que agradecen ser condimentados con nuez moscada, desde la salsa bechamel hasta la repostería. Se ralla sobre la elaboración casi al final para que libere sus aceites esenciales, su aroma y sabor.','No te puede faltar su inconfundible aroma y sabor.',1,'unidad',20,0,NULL,34,'nuez moscada.jpg',1),(14,1,'ESP011','Orégano','Es una de las plantas más populares dentro del uso gastronómico, siendo su uso realmente remoto y extendido en todo el mundo, aunque el origen propiamente dicho de la planta es propio del mediterráneo y algunas zonas de cercano oriente.  Es generalmente utilizada como condimento alimenticio, y sus hojas secas tienen un sabor y aroma mucho mejor que cuando están en su estado fresco.','Un clásico de esos que nunca deben faltar en tu cocina. ',100,'gr',50,12,25,80,'oregano.jpg',1),(15,1,'ESP012','Pimentón dulce','El pimentón molido es el polvo del pimiento rojo que se obtiene a partir del fruto seco y molido. La planta es originaria de México y llegó a Europa y a Marruecos hace muchos años a raíz de los viajes de los españoles hacia América. Este condimento le da un sabor muy atractivo a los platos. Es recomendable agregar este condimento siempre al final de la cocción para que no pierda su aroma y su sabor característico.','Condimentá tus platos con su atractivo sabor.',100,'gr',50,0,NULL,80,'pimenton dulce.jpg',1),(16,1,'ESP013','Pimienta blanca','Los granos de pimienta son las bayas del árbol Piper nigrum, de la familia de las piperáceas, un árbol trepador que crece en zonas tropicales húmedas. La pimienta blanca se caracteriza por ser suave. La pimienta no solo aromatiza platos sino que, gracias a la piperina que contiene, estimula la secreción de jugos gástricos, que facilitan la digestión. La mejor forma de aprovechar los aromas de la pimienta es comprarla en grano y molerla en el momento de añadirla en un plato.','Un toque suave pero inconfundible en tus preparaciones.',100,'gr',90,0,NULL,80,'pimienta blanca.jpg',1),(17,1,'ESP014','Chaucha de vainilla','La vainilla es originaria de México y del norte de Centroamérica (Guatemala, Honduras). Se sabe que tanto los aztecas como los mayas usaban la vaina de esta bella orquídea para aromatizar licores, e incluso el cacao, que se daba a beber a los nobles y a los guerreros.  Es un aromatizante sofisticado, que aporta una fragancia muy especial a los platos, guisos, y la repostería en la que se incluye.','Un sofisticado aromatizante para tus recetas.',100,'gr',70,0,NULL,22,'vainilla.jpg',1),(18,1,'ESP016','Maca en polvo','El polvo de extracto de maca es el que podemos usar en algunas preparaciones culinarias teniendo en cuenta que tiene un sabor ligeramente picante. Simplemente podemos añadir una cucharadita de maca a un batido o a un yogur en el desayuno o merienda, o bien, para consumir después de entrenar. Igualmente, podemos usar la maca para condimentar platos salados calientes o fríos, o bien, para acentuar el sabor dulce de algunas preparaciones como pueden ser galletas caseras o pasteles integrales.','Una cucharada de maca en una taza de agua caliente para sustituir el café mañanero.',100,'gr',100,10,NULL,80,'maca en polvo.jpg',1),(19,2,'LEG001','Amaranto','El amaranto puede incorporarse a la dieta para diversificar la misma y agregar buenos nutrientes, sobre todo, puede ser de utilidad en quienes llevan una alimentación vegana y buscan proteínas de origen vegetal de alta calidad. Puede ser un buen recurso para incrementar la saciedad de la dieta.','Incorporá un alimento saludable en tus recetas.',100,'gr',50,0,NULL,80,'amaranto.jpg',1),(20,2,'LEG002','Arvejas orgánicas','Estas exquisitas legumbres, se pueden utilizar en variadas preparaciones, desde ensaladas, guisos, y tartas y todas aquellas  que la imaginación nos permita realizar. Son excelentes para regular y generar la energía que necesitan los músculos durante la práctica de actividad física, y ayudan en el metabolismo de los nutrientes provenientes de otros alimentos.','Las arvejas son ricas en proteínas y carbohidratos, bajas en grasa y constituyen una buena fuente de fibra.',500,'gr',50,0,NULL,100,'arveja.jpg',1),(21,2,'LEG003','Garbanzos','El garbanzo es originario de Turquía y es gracias a los cartagineses que en la Península Ibérica lo cultivamos y nos lo comemos desde entonces. Existen 40 especies distintas de garbanzo y en España se reconocen cinco grandes variedades. Los garbanzos disminuyen el colesterol y triglicéridos, y promueven la salud cardiovascular. Deberían ocupar un sitio destacado en el trono de los superalimentos.','Un aliado indispensable para tu salud cardiovascular.',250,'gr',50,0,NULL,120,'garbanzo.jpg',1),(22,2,'LEG004','Lentejas','Estas brillantes leguminosas además de ser saludables pueden cocinarse en un sinfín de recetas que no cansan al paladar, desde sopas, ensaladas y guarniciones. Eso sí, para fomentar el amor por las lentejas es necesario evitar errores comunes al cocinarlas. Es importante comprar las lentejas más frescas que puedas encontrar, así podrás usarlas durante más tiempo.','Deliciosas y muy versátiles.',250,'gr',80,10,NULL,200,'lenteja.jpg',1),(23,2,'LEG005','Poroto negro','Los frijoles negros tienen un alto contenido en magnesio y una buena fuente de potasio y hierro, que son nutrientes esenciales que el cuerpo necesita. Los frijoles negros también contienen molibdeno (cuya función principal es desintoxicar al organismo del sulfito proveniente de distintos alimentos), calcio y zinc.','Muy saludables y deliciosos',250,'gr',30,0,NULL,60,'poroto negro.jpg',1),(24,2,'LEG006','Porotos de soja','La soja contienen los nueve aminoácidos esenciales para el organismo. Es por tanto una buena fuente de proteína vegetal, de vitaminas y de minerales cruciales para reducir el riesgo de sufrir enfermedades crónicas. Además contiene una buena proporción de fibra saciante que la hace adecuada para dietas de adelgazamiento.','Una comida saludable y fácil de implementar en cualquier receta',500,'gr',40,0,NULL,89,'poroto de soja.jpg',1),(25,3,'CER001','Germen de trigo','El germen de trigo es una parte tierna del cereal cuyo consumo recomendado es de entre dos y cuatro cucharadas diarias. Así, se puede tomar junto a otros cereales en el desayuno, para acompañar un yogur o sustituyéndolo por harina refinada. En este último caso se pude reemplazar media taza de harina por germen de trigo. También sirve como complemento dietético.','Agregale energía a tus días.',250,'gr',50,0,NULL,45,'germen de trigo.jpg',1),(26,3,'CER002','Avena','Los copos de avena son prácticos, deliciosos y muy nutritivos, así que no es extraño que se hayan convertido en uno de los ingredientes más apreciados en la alimentación saludable y que abunden las recetas con copos de avena. Cuando se incorpora la avena a la dieta habitual, por ejemplo los copos en el desayuno, es fácil sentir que muchas cosas mejoran: sienta bien, te sacia, se regula el tránsito intestinal..','Deliciosos y nutritivos.',250,'gr',45,10,NULL,546,'avena.jpg',1),(27,3,'CER003','Salvado de avena','Consumir productos de avena integrales (incluyen el salvado) proporciona mayor valor nutricional frente a cuando se consumen productos de avena refinada. El salvado de avena se encuentra también como un producto comercial y es posible añadirlo directamente a alimentos como yogur, utilizarlo en la realización de pan, enriquecimiento de otras harinas o productos, así como su utilización como complemento alimenticio.','Agregale nutrientes a tus yougures',250,'gr',50,0,NULL,34,'salvado de avena.jpg',1),(28,3,'CER004','Salvado de trigo','El salvado de trigo es lo queda tras refinar o procesar el grano de trigo, o sea, son las capas externas del grano (concretamente al pericarpio y sus diferentes subcapas). Por lo mismo, este antes considerado deshecho, es muy cotizado ya que contiene muchos nutrientes esenciales. Y aunque es un producto que es parte del grupo de harinas y cereales, no debemos temer, su consumo en cantidades adecuadas nos entregará muchos beneficios. ','Infaltable en tus preparaciones',250,'gr',15,0,NULL,675,'salvado de trigo.jpg',1),(29,3,'CER005','Copos de arroz','Su gran aporte en hidratos de carbono proporcionan gran energía, aconsejándose su consumo especialmente en niños y deportistas. Eficaz contra el estreñimiento. Su aporte en Magnesio ayuda a la reducción de azúcar en la sangre.','Cuidá de los que más querés',50,'gr',50,0,NULL,54,'copos de arroz.jpg',1),(30,3,'CER006','Cebada perlada','Contiene un alto grado de proteínas y es el que mayor cantidad de fibra solubles aporta entre los cereales integrales, por lo que colabora como laxante en los casos de estreñimiento ayudando a equilibrar la flora intestinal.','Aportale fribras a tus comidas',500,'gr',50,0,NULL,56,'cebada perlada.jpg',1),(31,4,'ARO001','Romero','El romero en la cocina. El romero es una hierba aromática de fuerte y agradable olor. Combina a las mil maravillas con carnes, especialmente con la de cordero y le da un sabor especial a las papas cocidas y otros vegetales. Se puede usar tanto fresco como seco','Romero seco',125,'gr',45,0,NULL,76,'romero.jpg',1),(32,4,'ARO002','Salvia','En la cocina, la salvia es muy utilizada, tanto fresca como seca, para acompañar carnes grasas, como el pato, el cordero o el cerdo (sobre todo en embutidos), además de quesos y pescados también grasos. Es muy usada en la cocina italiana y la francesa y desde la antigüedad se le conoce por su propiedades medicinales y terapéuticas, pues sirve como anti-inflamatorio, para aliviar problemas digestivos y es rica en antioxidantes.','Agregá sabor y perfume a tus preparaciones',150,'gr',50,5,NULL,67,'stevia.jpg',1),(33,4,'ARO004','Sésamo','Tahini es una pasta de semillas de ajonjolí (sésamo) típica de la cocina de oriente. a menudo se prepara con ajonjolí tostado y a veces se le agrega agua para que procese mejor. ... y prepararla solo con ajonjolí y dejarla cruda, sin tostar el ajonjolí. para conservar la mayoría de sus propiedades.','Semillas de sésamo para disfrutar en tus comidas ',60,'gr',100,0,NULL,89,'sesamo.jpg',1),(34,4,'ARO005','Tomillo','Agrega tomillo a sopas, guisos, estofados, adobos, tortillas o huevos revueltos. También puedes añadir ramitas enteras a las cazuelas para darle más sabor (recuerda quitarlas antes de servir). Una idea sabrosa es espolvorear hojas de tomillo y sal marina sobre las papas antes de asarlas.','Tomillo seco para perfumar tus comidas',50,'gr',60,0,NULL,67,'tomillo.jpg',1),(35,4,'ARO006','Laurel','Las hojas de laurel son idóneas en los platos cocinados a fuego lento, casando a la perfección con otras hierbas aromáticas como el perejil o el tomillo. Se añaden como aromatizador de estofados, adobos, salsas de carne o pescado, guisos de legumbres y verduras, sopas, cremas o parrilladas.','Dale un toque característico a tus platos',100,'gr',120,5,NULL,67,'laurel.jpg',1),(36,4,'ARO003','Cilantro','En la cocina latinoamericana, es prácticamente inconcebible cocinar sin el cilantro, ya que aparece utilizado tanto en seco como en fresco, entre los ingredientes de todas las recetas de salsas, moles, guisos de pollo, sopas, frijoles, guacamoles, etc. Se utiliza especialmente en Perú, Venezuela, Cuba y México, que son los países de esta zona en cuya gastronomía, está más implantado el uso de las hojas, tallos y raíces de esta hierba.','Prepará un típico plato y no te olvides del cilantro',60,'gr',89,0,NULL,56,'cilantro.jpg',1);
...
-- Dump completed on 2020-08-05 16:21:52
